...
program
    ...
    .option("-m, --model <model>", 'Model to target (gpt-5.5-pro default). GPT-5.6 API preview: gpt-5.6/gpt-5.6-sol, gpt-5.6-terra, gpt-5.6-luna, plus *-pro CLI aliases that enable reasoning.mode="pro". Also gpt-5.5, gpt-5.4-pro, gpt-5.4, gpt-5.1-pro, gpt-5-pro, gpt-5.1, gpt-5.1-codex API-only, gpt-5.2, gpt-5.2-instant, gpt-5.2-pro, gemini-3.1-pro API-only, gemini-3-pro, claude-4.6-sonnet, claude-4.1-opus, or ChatGPT labels like "5.5 Pro" / "5.2 Thinking" for browser runs).', normalizeModelOption)
    ...
    .addOption(new Option("--browser-thinking-time <level>", "Thinking effort: light, standard, extended, heavy, or pro (GPT-5.6).")
    .choices(["light", "standard", "extended", "heavy", "pro"])
    .hideHelp())
