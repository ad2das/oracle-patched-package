...
program
    ...
    .option("-m, --model <model>", 'Model to target (gpt-6-astra-pro default). GPT-6: gpt-6-astra or gpt-6-pro/gpt-6-astra-pro (Astra with Pro reasoning). GPT-5.6: gpt-5.6-sol, gpt-5.6-terra, gpt-5.6-luna and *-pro aliases. Earlier GPT, Gemini, Claude, and Grok models remain supported.', normalizeModelOption)
    ...
    .addOption(new Option("--browser-thinking-time <level>", "Thinking effort: light, standard, extended, heavy, or pro (GPT-6 / GPT-5.6).")
